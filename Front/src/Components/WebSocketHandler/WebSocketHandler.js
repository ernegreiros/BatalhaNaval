...
WebSocketHandler.TakeShot = (mycode, action, x, y, specialPowerPositions ,hitTarget, enemyDefeated) => {
    hubConnection.invoke("Action", mycode, action, x, y, specialPowerPositions, hitTarget, enemyDefeated).catch(function (err) {
        console.log(err.toString());
    });
}
